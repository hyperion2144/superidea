...
final CharacterShortcutEvent startCodeBlock = CharacterShortcutEvent(
  ...
  handler: (editorState) async {
    final result = await formatMarkdownSymbol(
      editorState,
...
final CommandShortcutEvent deleteCodeBlockCommand = CommandShortcutEvent(
  key: 'delete code block',
  command: 'Backspace',
  handler: (editorState) {
    ...
    if (delta.isEmpty) {
      ...
      if (transaction.document.root.children.length == 1) {
